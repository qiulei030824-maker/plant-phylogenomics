...
Usage:
    python scripts/02_analyze_domtblout.py <PFAM_ID>
    python scripts/02_analyze_domtblout.py <PFAM_ID> -i /path/to/domtblout -o /path/to/output
    python scripts/02_analyze_domtblout.py PF00168
    python scripts/02_analyze_domtblout.py PF00168 -i /data/xxx/hmmer/all_PF00168.domtblout
...
def parse_domtblout(filepath):
    ...
    Returns list of dicts with keys: gene, domain_idx, domain_count,
    full_seq_evalue, dom_ievalue, ali_from, ali_to.
    """
    records = []
    skipped_comment = 0
    skipped_short = 0
    ...
    with open(filepath) as f:
        for line in f:
            ...
            # domtblout v3 format (0-based index):
            #   0: target name      1: target accession  2: tlen
            #   3: query name       4: query accession   5: qlen
            #   6: seq E-value      7: seq score         8: seq bias
            #   9: domain #        10: of domains       11: c-Evalue
            #  12: i-Evalue        13: dom score        14: dom bias
            #  15: hmm from        16: hmm to           17: ali from
            #  18: ali to          19: env from         20: env to
...
def main():
    ...
    species_rows = task2_species_gene_count(records, task2_out, args.delimiter)
