...
Usage:
    python 03_extract_domain_sequences.py <PFAM_ID>
    python 03_extract_domain_sequences.py <PFAM_ID> -i /path/to/domtblout -o /path/to/output_dir
    python 03_extract_domain_sequences.py PF00168
    python 03_extract_domain_sequences.py PF00168 -i /data/xxx/hmmer/all_PF00168.domtblout --skip-cds
    python 03_extract_domain_sequences.py PF00168 --data-dir /custom/data/dir
...
def main():
    ...
    print(f"\nNext step: python 04_build_phylogenetic_tree.py {pfam_id}")
    print("=" * 60)
